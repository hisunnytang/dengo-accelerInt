...
*/            
            ...
            #endif
            num_solved += num_cond;
            //cudaErrorCheck( cudaMemcpy( rhs_call, device_mech->rhs_call, sizeof(int), cudaMemcpyDeviceToHost));
            //cudaErrorCheck( cudaMemcpy( jac_call, device_mech->jac_call, sizeof(int), cudaMemcpyDeviceToHost));
...
*/
    ...
    printf("Call to RHS function: %d \n", rhs_call);
    printf("Call to JAC function: %d \n", jac_call);
